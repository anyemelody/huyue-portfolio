...
export const eras = [
    ...
    projects: [
      {
        ...
        detail: {
          ...
          body: 'Effect House is a public-facing desktop tool to create, publish and share AR effects for TikTok. I led the Effect House Template Team — inspiring community creators with trending effects and fresh ideas, and showcasing new features.',
  ...
  },
  {
    ...
    projects: [
      {
        slug: 'hershey-pop-kisses', name: 'Hershey Pop Kisses', meta: 'Havas · Daydream VR game', hue: 42,
        ...
        detail: {
          ...
          body: 'An interactive VR game installation for Hershey, exhibited at Hershey Stores in Pennsylvania and Las Vegas. The goal: generate interest in Hershey products, drive retail traffic, and inspire customers to share online. Built end-to-end — from creative coding and interaction design to motion/animation implementation on Google Daydream.',
        },
      },
      {
        slug: 'vuse-unboxing-ar', name: 'Vuse Unboxing AR', meta: 'Havas · AR mobile', hue: 160,
        ...
        detail: {
          ...
          body: 'A "virtual product trial" AR experience for VUSE\'s Alto launch — put a virtual Alto in consumers\' hands to navigate product features in layers, from assembly to full x-ray view.',
        },
      },
      {
        slug: 'ibm-watson', name: 'IBM Watson AR', meta: 'Havas · AR mobile', hue: 198,
        ...
        detail: {
          ...
          body: 'IBM Watson Holobot — "The Future of the Call Center". An AR storytelling experience educating users how Watson AI adds value to call centers. Unveiled at the 2018 IBM Think Event.',
        },
      },
      {
        slug: 'santander', name: 'Santander', meta: 'AR mobile · 🏆 Webby 2019', hue: 8,
        ...
        detail: {
          ...
          body: 'In Someone Else\'s Shoes — designed for Santander to donate $10 for every mile walked to Boston nonprofit Heading Home. An AR mobile app with volumetric video creating an immersive empathy experience.',
        },
      },
      {
